...
def main():
    ...
    # README.txtを作成しvoicevoxを使用したクレジットを記載
    with open(os.path.join(DST_DIR, "README.txt"), "w", encoding="utf-8") as f:
        f.write("This sound prompt package uses voice generated by VOICEVOX Nemo.")
    print("README.txtを作成しました")

    # tar.gzファイルを作成
    package_name = "gs-sounds-ja"
    shutil.make_archive(package_name, "gztar", DST_DIR)
    print(f"{package_name}.tar.gzを作成しました")
